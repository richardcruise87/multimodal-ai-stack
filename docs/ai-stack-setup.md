...
**Langfuse UI:**
Open `http://localhost:3000` and log in with `admin@local.dev` / `changeme123`. After a successful LiteLLM call, a trace should appear under your project within a few seconds.
...
| Langfuse UI | `http://localhost:3000` | `admin@local.dev` / `changeme123` |
